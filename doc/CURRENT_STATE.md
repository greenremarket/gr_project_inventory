...
- `Cr�er le lot Aiken`: checkbox on Formulaire de lancement d'op�ration triggers synchronous lot INSERT in `awbc_db.Lots`; non-blocking (bus.bus warning toast on failure). `Cr�er et aller � la t�che` navigation button. Live-validated 2026-04-01.
